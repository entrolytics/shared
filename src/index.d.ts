...
export declare const API_ROUTES: {
  ...
  readonly deploymentCompare: (id: string) => string;
...
export declare function normalizeDeploymentSource(
...
export declare function getFrameworkPackage(
  framework: Framework,
):
  | "@entrolytics/nextjs-sdk"
